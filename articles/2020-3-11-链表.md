...
>
>    1. 同时开始遍历，当短的到了尾节点的时候，他们都走了S 步，这时候把**短节点指针指向长节点头部**，再继续同时遍历
>    2. 再走（L-S）步后，长节点就走了（S+(L-S)=L）步后也到了自己尾部，然后**将其指向短节点头部**
>
>    最关键的地方在于，短链表头节点指针在重置为指向长链表头节点之后，即第2步中，也走了L-S步，而长链表指针在第二步中也重置为了短节点头部。相当于长链表头指针先走 L-S 步。
>
